...
Основной концепцией Boost.Serialization является архив. Архив - это последовательность байтов, которая представляет собой сериализованные C++ объекты. Они могут быть добавлены в архив для сериализации, а затем загружены из архива. Для восстановления ранее сохраненных объектов C++, предполагаются одинаковые типы.
